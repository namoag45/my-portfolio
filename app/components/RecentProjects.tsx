      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <div className="max-w-3xl mx-auto text-xl text-gray-300">
              <TextGenerateEffect
                words="Explore my latest work showcasing full-stack development, AI
              integration, and modern UI design."
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-1 gap-10"> 
            {/* grid grid-cols-1 md:grid-cols-2 gap-10 --> for 2 in one line*/}
